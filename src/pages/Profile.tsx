...
export default function Profile() {
    ...
    if (!session) {
        // ... Login Form (Existing logic simplified for brevity in this replace block, assume similar to before)
        return (
            <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
                <Card className="p-8 w-full max-w-md bg-white/50 backdrop-blur-sm shadow-electric">
                    <h1 className="text-2xl font-bold mb-6 text-center">Login / Cadastro</h1>
                    <Tabs defaultValue="login" onValueChange={(v) => setAuthMode(v as any)}>
                        ...
                        <form onSubmit={handleAuth} className="space-y-4">
                            ...
                            <Button type="submit" className="w-full bg-gradient-electric text-white" disabled={authLoading}>
